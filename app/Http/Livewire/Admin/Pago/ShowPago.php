...
class ShowPago extends Component
{
    ...
    public $clientesactivos, $clientesvencidos, $clientescortesinejecutar, $clientesejecutados, $idcliente, $client;
    ...
    public function abrirmodalpago(Cliente $cliente)
    {
        ...
        $this->nombrecompleto = $this->client->nombre . " " . $this->client->apellido;
    ...
    public function render()
    {
        $clientes = Cliente::join("servicios", "servicios.cliente_id", "=", "clientes.id")
            ...
            ->paginate($this->cant);
        return view('livewire.admin.pago.show-pago', compact('clientes'));
    }
}
