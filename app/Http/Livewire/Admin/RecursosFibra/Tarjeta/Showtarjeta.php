...
namespace App\Http\Livewire\Admin\RecursosFibra\Tarjeta;
...
class Showtarjeta extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        $tarjetas = DB::Table('tarjetas')
            ...
            ->paginate($this->cant);
        return view('livewire.admin.recursos-fibra.tarjeta.showtarjeta', compact('tarjetas'));
    }
}
