<div>
            ...
            <div class="bg-white  rounded-2xl px-10 py-8 shadow-lg hover:shadow-2xl transition duration-500 w-full">
                <div class="w-full">
                    <div class=w-full">
                        ...
                        @include('livewire.admin.recursos-fibra.tarjeta.modalcrear')
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="___class_+?49___">
                                            ...
                                            <td class="px-5 py-1 border-b border-gray-200 text-sm text-center">
                                                ...
                                                @can('admin.recursosfibra.tarjetas.editar')
                                                <a wire:click="edit({{$tarjeta->id}})" class="btn2 btn-blue mb-1 py-2">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                @endcan
                                                @can('admin.recursosfibra.tarjetas.cambiarestado')
    ...
    @include('livewire.admin.recursos-fibra.tarjeta.modaleditar')
    <script>
