<div>
            ...
            <div class="bg-white  rounded-2xl px-8 py-6 shadow-lg hover:shadow-2xl transition duration-500 w-full">
                <div class="w-full">
                    <div class=w-full">
                        ...
                        @include('livewire.admin.recursos-fibra.datacenter.modalcrear')
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="">
                                            ...
                                            <td class="px-3 py-1 border-b border-gray-200 text-sm text-center">
                                                @can('admin.recursosfibra.datacenters.editar')
                                                <a wire:click="edit({{$datacenter->id}})"
                                                    class="btn2 btn-blue mb-1 py-2">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                @endcan
                                                @can('admin.recursosfibra.datacenters.cambiarestado')
    ...
    @include('livewire.admin.recursos-fibra.datacenter.modaleditar')
    <script>
