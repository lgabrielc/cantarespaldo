<div>
                ...
                <div class="w-full bg-white rounded-xl overflow-hdden shadow-md p-4 undefined">
                    <div class="flex flex-wrap border-b border-gray-200 undefined">
                        ...
                        <div class="w-full pl-4 max-w-full flex-grow flex-1 mb-2 text-right undefined">
                            <h5 class="text-gray-500 font-light tracking-wide text-base mb-1">Numero de Cajas Nap</h5>
            ...
            <div class="bg-white  rounded-2xl px-10 py-8 shadow-lg hover:shadow-2xl transition duration-500 w-full">
                <div class="w-full">
                    <div class=w-full">
                        ...
                        @include('livewire.admin.recursos-fibra.nap.modalcrear')
                            ...
                            <div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
                                ...
                                <table class="min-w-full leading-normal">
                                    <thead>
                                        <tr>
                                            <th wire:click="order('id')"
                                                class="cursor-pointer px-3 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                                ID
                                                @if ($sort == 'id')
                                                @if ($direction == 'asc')
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="">
                                            <td class="
                                                    px-3 py-4 border-b border-gray-200 bg-white text-base ">
                                            ...
                                            <td class="px-3 py-1 border-b border-gray-200 text-sm text-center">
                                                @can('admin.recursosfibra.naps.agregar')
                                                <a wire:click="edit({{$nap->id}})" class="btn2 btn-blue mb-1 py-2">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                @endcan
                                                @can('admin.recursosfibra.naps.cambiarestado')
    ...
    @include('livewire.admin.recursos-fibra.nap.modaleditar')
    <script>
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                Swal.fire(
                    'Actualizado!',
                    'La Caja Nap ha cambiado su estado con éxito.',
                    'success'
                )
            }
        })
