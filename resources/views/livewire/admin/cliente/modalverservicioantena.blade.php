<x-jet-dialog-modal wire:model='vermodalantena'>
    <x-slot name="title">
        ...
        @can('admin.clientes.editar.servicio')
    ...
    <x-slot name="content">
        <div class="flex flex-col w-full md:flex-row">
            <div class="w-full p-2 ">
                ...
                <x-jet-input type="text"
                    class="block w-full px-6 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1"
            ...
            <div class="w-full p-2 ">
                ...
                <x-jet-input type="text"
                    class="block w-full px-6 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1"
                    wire:model.defer="apellido" disabled />
            </div>
        </div>
        <div class="flex flex-col w-full md:flex-row">
            <div class="w-full p-2 ">
                ...
                <x-jet-input type="text"
                    class="block w-full px-6 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1"
                    wire:model.defer="tiposervicio" disabled />
            </div>
            <div class="w-full p-2 ">
                <label class="block text-gray-500 font-bold mb-1 md:mb-0 pr-4">
                    Condicion Antena
                ...
                <select class="border rounded-lg block w-full px-6 border py-1 mt-1 border-secondary"
                    wire:model="condicionantena" {{$isDisabled}}>
        ...
        <div class="flex flex-col w-full md:flex-row">
            <div class="w-full p-2 ">
                ...
                <x-jet-input type="text"
                    class="block w-full px-6 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1"
                    wire:model.defer="mac" disabled={{$disabled2}} />
                @error('mac')
                <div class="text-red-500">{{ $message }}</div>
                @enderror
            </div>
            <div class="w-full p-2 ">
                ...
                <x-jet-input type="text"
                    class="block w-full px-6 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1"
                    wire:model.defer="ip" disabled={{$disabled2}} />
                @error('ip')
                <div class="text-red-500">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="flex flex-col w-full md:flex-row">
            <div class="w-full p-2 ">
                ...
                <x-jet-input type="text"
                    class="block w-full px-6 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1 border py-1 mt-1"
                    wire:model="frecuencia" disabled={{$disabled2}} />
                @error('frecuencia')
                <div class="text-red-500">{{ $message }}</div>
                @enderror
            </div>
            <div class="w-full p-2 ">
                ...
                <select class="border rounded-lg block w-full px-6 border py-1 mt-1 border-secondary"
                    wire:model.defer="antena" {{$isDisabled}}>
        ...
        <div class="flex flex-col w-full md:flex-row">
            <div class="w-full p-2 ">
                ...
                <select class="border rounded-lg block w-full px-6 border py-1 mt-1 border-secondary"
                    wire:model.defer="plan" {{$isDisabled}}>
            ...
            <div class="w-full p-2 ">
                ...
                <select class="border rounded-lg block w-full px-6 border py-1 mt-1 border-secondary"
                    wire:model.defer="estado" {{$isDisabled}}>
