<div>
                    ...
                    <div class="flex flex-wrap border-b border-gray-200 undefined">
                        ...
                        <div class="w-full pl-4 max-w-full flex-grow flex-1 mb-2  undefined">
                            ...
                            <div class="flex justify-end">
                                @can('admin.clientes.agregar.plan')
                                <span class="">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="py-1 border-b border-gray-200 text-sm text-center">
                                                ...
                                                @can('admin.clientes.ver.servicio')
                                                ...
                                                @endcan
                                                @endif
                                                @can('admin.clientes.migrar.servicio')
                                                <a wire:click="vermigracion({{$cliente->id}})"
                                                    class="bg-gradient-to-r from-purple-200 to-purple-600 btn2 btn-purple mb-1 py-2">
                                                    <i class="fas fa-exchange-alt"></i>
                                                </a>
                                                @endcan
                                                @can('admin.clientes.eliminar.servicio')
                                                <a wire:click="$emit('deleteservicio',{{$cliente->id}})"
                                                    class="bg-gradient-to-r from-purple-200 to-purple-600 btn2 btn-purple mb-1 py-2">
                                                    <i class="far fa-trash-alt"></i>
                                                </a>
                                                @endcan
                                                @else
                                                @can('admin.clientes.agregar.servicio')
                                                ...
                                                @endcan
                                                @endif
                                                @can('admin.clientes.editar.cliente')
                                                <a wire:click="edit({{$cliente->id}})"
                                                    class="bg-gradient-to-r from-blue-200 to-blue-600 btn2 btn-blue mb-1 py-2">
    ...
    <script>
        livewire.on('delethisplan', planid => {
            Swal.fire({
                title: 'Estás seguro?',
    ...
    <script>
        livewire.on('deleteservicio', thisid => {
            Swal.fire({
                title: 'Estás seguro?',
                text: "¡No podrás revertir esto!",
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    @this.call('deleteservicio', thisid)
                    Swal.fire(
                        'Deleted!',
