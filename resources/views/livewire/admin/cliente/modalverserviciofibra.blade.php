    ...
    <x-slot name="content">
        <div class="flex flex-col w-full md:flex-row">
            <div class="w-full p-2 ">
                ...
                <x-jet-input type="text" class="block w-full px-6 border py-1 mt-1" value="{{$nombre}} {{$apellido}}"
                    disabled />
            </div>
            <div class="w-full p-2 ">
                <label class="block text-gray-500 font-bold mb-1 md:mb-0 pr-4">
                ...
                <x-jet-input type="text" class="block w-full px-6 border py-1 mt-1" value="{{$tiposervicio}}"
                    disabled />
                @error('tiposervicio')
        ...
        <div class="flex flex-col w-full md:flex-row">
            <div class="w-full p-2 ">
                ...
                <select class="border rounded-lg block w-full px-6 border py-1 mt-1 border-secondary"
                    wire:model="datacenterid" wire:change='generarolts' {{$isDisabled}}>
        ...
        <div class="flex flex-col w-full md:flex-row">
            <div class="w-full p-2 ">
                ...
                <x-jet-input type="text" class="block w-full px-6 border py-1 mt-1" value="{{$tarjetanombre}}"
                    disabled />
                @else
                <select class="border rounded-lg block w-full px-6 border py-1 mt-1 border-secondary"
                    wire:model="tarjetaid" wire:change='tarjetagponrelacion' {{$isDisabled}}>
            ...
            <div class="w-full p-2 ">
                ...
                @else
                <select class="border rounded-lg block w-full px-6 border py-1 mt-1 border-secondary"
                    wire:model="gponid" wire:change='gponnaprelacion' {{$isDisabled}}>
        ...
        <div class="flex flex-col w-full md:flex-row">
            <div class="w-full p-2 ">
                ...
                <select class="border rounded-lg block w-full px-6 border py-1 mt-1 border-secondary"
                    wire:model.defer="planid" {{$isDisabled}}>
