<div>
            ...
            <div class="px-4 my-4">
                <div class="w-full bg-white rounded-xl overflow-hdden shadow-md p-4 undefined">
                    <div class="flex flex-wrap border-b border-gray-200 undefined">
                        <div
                            class="bg-gradient-to-tr from-green-200 via-green-300 to-blue-700 -mt-10 mb-4 rounded-xl text-white grid items-center w-24 h-24 py-4 px-4 justify-center shadow-lg-pink mb-0">
                        ...
                        <div class="w-full pl-4 max-w-full flex-grow flex-1 mb-2 text-right undefined">
                            <h5 class="text-gray-500 font-light tracking-wide text-base mb-1">Numero de Usuarios</h5>
                            <span class="text-3xl text-gray-900">{{ $usuarios->count() }}</span>
                        </div>
                    </div>
    ...
    <div class=" max-w-7x1 mx-auto px-4 sm:px-6 lg:px-8 ">
        <div class="w-full">
            <div class="bg-white  rounded-2xl px-10 py-8 shadow-lg hover:shadow-2xl transition duration-500 w-full">
                <div class="w-full">
                    <div class=w-full">
                        <h1 class="text-2xl font-semibold leading-tight mb-2">Gestionar Usuarios</h1>
                        @include('livewire.admin.usuario.modalcrear')
    ...
    @include('livewire.admin.usuario.modaleditar')
    <script>
        livewire.on('delethis', thisid => {
            Swal.fire({
                title: 'Estás seguro?',
                text: "Eliminaras el usuario!",
                icon: 'warning',
