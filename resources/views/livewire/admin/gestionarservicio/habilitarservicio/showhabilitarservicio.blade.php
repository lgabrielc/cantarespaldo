<div>
    <div class="w-full mx-auto">
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 content-center">
                ...
                <div class="w-full bg-white rounded-xl overflow-hdden shadow-md p-4 undefined">
                    <div class="flex flex-wrap border-b border-gray-200 undefined">
                        ...
                        <div class="w-full pl-4 max-w-full flex-grow flex-1 mb-2 text-right undefined">
                            <h5 class="text-gray-500 font-light tracking-wide text-base mb-1">Servicios con Corte
                                Ejecutado</h5>
                            <span class="text-3xl text-gray-900">
                                {{ $totalserviciocortejectuado }}
                            </span>
                        </div>
                    </div>
            ...
            <div class="pt-4 px-4 mb-2">
                <div class="w-full bg-white rounded-xl overflow-hdden shadow-md p-4 undefined">
                    <div class="flex flex-wrap border-b border-gray-200 undefined">
                        <div
                            class="bg-gradient-to-tr from-indigo-500 to-yellow-700 -mt-10 mb-4 rounded-xl text-white grid items-center w-24 h-24 py-4 px-4 justify-center shadow-lg-pink mb-0">
                            <span class="material-icons text-white text-3xl leading-none">trending_up</span>
                        </div>
                        <div class="w-full pl-4 max-w-full flex-grow flex-1 mb-2 text-right undefined">
                            <h5 class="text-gray-500 font-light tracking-wide text-base mb-1">Servicios con Retiro de
                                Equipos</h5>
                            <span class="text-3xl text-gray-900">
                                {{ $totalservicioretirodeequipos }}
                            </span>
                        </div>
                    </div>
                    <div class="text-sm text-gray-700 pt-4 flex items-center undefined"><span
            ...
            <div class="pt-4 px-4 mb-2">
                <div class="w-full bg-white rounded-xl overflow-hdden shadow-md p-4 undefined">
                    <div class="flex flex-wrap border-b border-gray-200 undefined">
                        <div
                            class="bg-gradient-to-tr from-gray-500 to-pink-700 -mt-10 mb-4 rounded-xl text-white grid items-center w-24 h-24 py-4 px-4 justify-center shadow-lg-pink mb-0">
                            <span class="material-icons text-white text-3xl leading-none">trending_up</span>
                        </div>
                        <div class="w-full pl-4 max-w-full flex-grow flex-1 mb-2 text-right undefined">
                            <h5 class="text-gray-500 font-light tracking-wide text-base mb-1">Servicios en Estado de
                                Retiro</h5>
                            <span class="text-3xl text-gray-900">
                                {{ $totalservicioretirado }}
                            </span>
                        </div>
                    </div>
                    <div class="text-sm text-gray-700 pt-4 flex items-center undefined"><span
    ...
    <div class=" max-w-7x1 mx-auto px-4 sm:px-6 lg:px-8 ">
        <div class="w-full">
            <div class="bg-white  rounded-2xl px-10 py-8 shadow-lg hover:shadow-2xl transition duration-500 w-full">
                <div class="w-full">
                    <div class=w-full">
                        <h1 class="text-2xl font-semibold leading-tight mb-2">Deshabilitar / Habilitar Servicio</h1>
                        ...
                        <div class="my-2 flex sm:flex-row flex-col">
                            <div class="pr-2 flex flex-row mb-1 sm:mb-0 content-center justify-center">
                                <div class="flex relative content-center ">
                                    ...
                                    <select wire:model="opcionvista"
                                        class="ml-2 w-auto appearance-none h-full rounded-l border block appearance-none w-full bg-white border-gray-400 text-gray-700 py-2 px-4 pr-8 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="py-1 border-b border-gray-200 text-sm text-center">
                                                ...
                                                @can('admin.gestionarservicios.habilitarservicios.habilitarservicio')
                                                <a wire:click="$emit('changesinejecutar',{{ $cliente->id }})"
                                                    class="btn2 btn-green mb-1 py-2">
                                                    <i class="fas fa-folder-plus"></i>
                                                </a>
                                                @endcan
                                                @else
                                                @can('admin.gestionarservicios.habilitarservicios.deshabilitarservicio')
                                                <a wire:click="$emit('changeretirar',{{ $cliente->id }})"
    ...
    <script>
        livewire.on('changeretirar', serviceid => {
            Swal.fire({
                title: 'Estás seguro?',
                text: "¡Confirme el retiro de servicio!",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                confirmButtonText: '¡Sí, Retirar Servicio!'
            }).then((result) => {
                if (result.isConfirmed) {
                    @this.call('changearetirado', serviceid)
                    Swal.fire(
                        'Éxito!',
                        'Retiro Realizado.',
                        'success'
        ...
        livewire.on('changesinejecutar', serviceid => {
            Swal.fire({
                title: 'Estás seguro?',
                text: "¡Confirme la actualizacion de servicio!",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                ...
                if (result.isConfirmed) {
                    @this.call('changeacorteejecutado', serviceid)
                    Swal.fire(
                        'Éxito!',
                        'Cambio Realizado.',
                        'success'
