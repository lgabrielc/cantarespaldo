<div>
    <div class="w-full mx-auto">
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 content-center">
                ...
                <div class="w-full bg-white rounded-xl overflow-hdden shadow-md p-4 undefined">
                    <div class="flex flex-wrap border-b border-gray-200 undefined">
                        ...
                        <div class="w-full pl-4 max-w-full flex-grow flex-1 mb-2 text-right undefined">
                            <h5 class="text-gray-500 font-light tracking-wide text-base mb-1">Servicios con Corte sin
                                Ejecutar</h5>
                            <span class="text-3xl text-gray-900">
                                {{ $totalserviciocortesinejecutar }}
                            </span>
                        </div>
                    </div>
    ...
    <div class=" max-w-7x1 mx-auto px-4 sm:px-6 lg:px-8 ">
        <div class="w-full">
            <div class="bg-white  rounded-2xl px-10 py-8 shadow-lg hover:shadow-2xl transition duration-500 w-full">
                <div class="w-full">
                    <div class=w-full">
                        <h1 class="text-2xl font-semibold leading-tight mb-2">Cortar Servicio</h1>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="py-1 border-b border-gray-200 text-sm text-center">
                                                @can('admin.gestionarservicios.cortarservicios.cortarservicio')
                                                <a wire:click="$emit('cortarthis',{{ $cliente->id }})"
    ...
    <script>
        livewire.on('cortarthis', serviceid => {
            Swal.fire({
                title: 'Estás seguro?',
                ...
                if (result.isConfirmed) {
                    @this.call('cortarservicio', serviceid)
                    Swal.fire(
                        'Éxito!',
                        'Corte Realizado.',
                        'success'
