<x-jet-dialog-modal wire:model='vermodaldescongelar'>
    ...
    <x-slot name="content">
        <div class="flex flex-col w-full md:flex-row">
            <div class="w-full p-2 ">
                ...
                <x-jet-input type="text" class="block w-full px-6 border py-1 mt-1" value={{$nombrecompleto}}
                    disabled />
                @error('nombre')
        ...
        <div class="flex flex-col w-full md:flex-row">
            <div class="w-full p-2 ">
                ...
                <x-jet-input type="text" class="block w-full px-6 border py-1 mt-1" wire:model.defer="estado"
                    disabled />
                @error('estado')
                <div class="text-red-500">{{ $message }}</div>
                @enderror
        ...
        <div class="flex flex-col w-full md:flex-row">
            ...
            <div class="w-full p-2 ">
                ...
                <x-jet-input type="text" class="block w-full px-6 border py-1 mt-1" wire:model.defer="periododesaldo"
                    disabled />
    ...
    <x-slot name="footer">
        ...
        @can('admin.gestionarservicios.descongelarservicios.descongelarservicio')
