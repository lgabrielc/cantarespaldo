<div>
    <div class="mx-auto">
        <div class="grid grid-cols-1 lg:grid-cols-1 xl:grid-cols-1 content-center">
            <div class="pt-4 px-4 mb-4">
                <div class="w-full bg-white rounded-xl overflow-hdden shadow-md p-4 undefined">
                    <div class="flex flex-wrap border-b border-gray-200 undefined">
                        ...
                        @foreach ($totalincidencias as $onlyincidencia)
                        <div class="w-full pl-4 max-w-full flex-grow flex-1 mb-2 text-right undefined">
                            <h5 class="text-gray-500 font-light tracking-wide text-base mb-1">N° Incidencias
                                de tipo {{$onlyincidencia->nombre}}</h5>
                            </h5>
                            <span class="text-3xl text-gray-900">
                                {{$onlyincidencia->incidencias->count()}}
                            </span>
                        </div>
                        @endforeach
                    </div>
    ...
    <div class=" max-w-7x1 mx-auto px-4 sm:px-6 lg:px-8 ">
        <div class="w-full">
            <div class="bg-white  rounded-2xl px-10 py-8 shadow-lg hover:shadow-2xl transition duration-500 w-full">
                <div class="w-full">
                    <div class=w-full">
                        <h1 class="text-2xl font-semibold leading-tight mb-2">Historial de Incidencias</h1>
